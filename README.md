...
| npm-lockfile-version | The lockfile version in use if npm is the selected package-manager                                                                                                                                                                                                                                                                | false    | 1                                    |
| additional-changes   | A JSON object of additional changes where the key is a filename and the value is an array of acceptable changes in that file e.g. `{"README.md": ["- \"version\": \"", "+ \"version\": \""]}`. Use the value "\*" to allow any changes to a particular file. (see [validating changes](#validating-changes) for more information) | false    | {}                                   |
